...
class Solution {
    public int solution(String str1, String str2) {
        ...
        listChange(str1, list1);
        listChange(str2, list2);
        ...
        if(max == 0 && min == 0) {
            ...
            return (int)Math.floor(result*answer);
        }
    }

//    HashSet<String> union(ArrayList<String> list1, ArrayList<String> list2) {
...
//    }
    ...
    ArrayList<String> listChange(String str, ArrayList<String> arr) {
        String[] strArr = str.split("");
        System.out.println("Split words : "+Arrays.toString(strArr));
        for(int i=0; i<strArr.length-1; i++) {
            if(Pattern.matches("^[a-z]*$" ,strArr[i]) && Pattern.matches("^[a-z]*$", strArr[i+1])) {
                if (strArr[i].equals(" ")) {
                    continue;
                } else if (strArr[i + 1].equals(" ")) {
                    continue;
                } else {
                    arr.add(strArr[i] + strArr[i + 1]);
                }
            }
        }
        return arr;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.solution("A+C","DEF"));  // 0
    }
}
