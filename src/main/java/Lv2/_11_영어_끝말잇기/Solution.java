...
//                System.out.println(words[i].charAt(0));
                if(wordsBox.contains(words[i])) {
                    break;
                }else {
                    wordsBox.add(words[i]);
                }
            }else {
                break;
            }
        ...
        if(wordsBox.size() == words.length){
            return answer;
        }
        answer[0] = ((wordsBox.size())%n)+1;
        answer[1] = ((wordsBox.size())/n)+1;

//        System.out.println(wordsBox.size());
