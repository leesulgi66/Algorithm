package javaPrac.ch11_collections_framework._03_StackAndQueue;
...
public class MyStack extends Vector {
    ...
    public Object pop() {
        ...
        // 마지막 요소를 삭제한다. 배열의 index가 0부터 시작하믈 1을 빼준다.
    ...
    public int search(Object o) {
        ...
        if(i>=0) {  // 객체를 찾은 경우
            return size() - i;      // Stack은 맨 위에 저장된 객체의 index를 1로 정의하기 때문에 계산을 통해 구한다.
        }
