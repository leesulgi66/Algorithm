...
public class MyVector implements List {
    ...
    public Object remove(int index) {
        ...
        // 마지막 데이터를 null로 한다. 배열은 0 부터 시작함로 마지막 요소는 index가 size-1이다.
        data[size-1] = null;
        size--;
        return oldObj;
    }
...
//    public void clear();
    public boolean equalse(Object o) { return false; }
//    public int hashCode();
//    public Object get(int index);
...
//    public Object remove(int index);
    ...
    public List subList(int forIndex, int toIndex) { return null; }
