...
class Solution {
    public int[] solution(String[] wallpaper) {
        ...
        int lux=wallpaper.length, luy=50, rdx=0, rdy=0;

        for(int i=0; i<wallpaper.length; i++) {
            String str = wallpaper[i];
            if(str.contains("#")){
                int firstNum = str.indexOf("#");
                int lastNum = str.lastIndexOf("#");
                rdx = i+1;
                if(lux >= i)
                    lux = i;
                if(luy > firstNum)
...
//                System.out.println("rdy : "+rdy);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(s.solution(new String[]{".#...", "..#..", "...#."})));   // [0, 1, 3, 4]
        System.out.println(Arrays.toString(s.solution(new String[]{"....","...#"})));   // [1, 3, 2, 4] test case
        System.out.println(Arrays.toString(s.solution(new String[]{".##...##.", "#..#.#..#", "#...#...#", ".#.....#.", "..#...#..", "...#.#...", "....#...."})));   // [0, 0, 7, 9]
        System.out.println(Arrays.toString(s.solution(new String[]{"..", "#."})));   // [1, 0, 2, 1]
    }
}
